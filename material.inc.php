...
$this->resources = array(
	...
	"end_condition" => clienttranslate('The biggest stack of each player is discarded. If the biggest stack is the players guild a second stack is discarded as well.<br> The release prisoners card power is automatically applied if advantageous.')
);

$this->cardpowers = array(
    1   => clienttranslate("Stairs"       ),
    2   => clienttranslate("Secret Path" ),
	3   => clienttranslate("Release"      ),
